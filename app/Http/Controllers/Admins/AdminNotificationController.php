...
class AdminNotificationController extends Controller
{
    ...
    {
        $accountId = null; // Admin notifications (account_id = null)
    ...
    {
        $count = $this->notificationService->deleteRead();
    ...
    {
        $notifications = $this->notificationService->getNotifications(null, 10, true);
