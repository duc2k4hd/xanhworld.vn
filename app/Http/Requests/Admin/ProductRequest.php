...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'description.instruction' => ['nullable', 'string'],
            'description.specifications' => ['nullable', 'array'],
            'description.general' => 'nullable|array',
            'description.highlights' => 'nullable|array',
            'description.specifications.height' => ['nullable', 'string', 'max:255'],
            'description.specifications.foliage' => ['nullable', 'string', 'max:255'],
            'description.specifications.light' => ['nullable', 'string', 'max:255'],
            'description.specifications.water' => ['nullable', 'string', 'max:255'],
            'description.specifications.fengshui' => ['nullable', 'string', 'max:1000'],
            'description.specifications.position' => ['nullable', 'string', 'max:500'],
            'description.specifications.scientific_name' => ['nullable', 'string', 'max:255'],
            'description.specifications.keywords' => ['nullable', 'array'],
            ...
            'category_included_ids' => [
                'nullable', 
                'array',
                Rule::prohibitedIf(fn() => !empty($this->input('product_included_ids'))),
            ],
            ...
            'product_included_ids' => [
                ...
                'array', 
                'max:6',
                Rule::prohibitedIf(fn() => !empty($this->input('category_included_ids'))),
            ],
            'product_included_ids.*' => ['integer', 'exists:products,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'product_included_ids.max' => 'Chỉ được chọn tối đa 6 sản phẩm mua kèm.',
            'product_included_ids.prohibited' => 'Không được chọn sản phẩm cụ thể khi đã chọn danh mục gợi ý.',
            'category_included_ids.prohibited' => 'Không được chọn danh mục gợi ý khi đã chọn sản phẩm cụ thể.',
        ];
    }
}
