...
<section>
    <div class="xanhworld_chat">
        ...
        <!-- Zalo -->
        <a href="https://zalo.me/{{ $settings->contact_zalo ?? '' }}" aria-label="Zalo" alt="Zalo" target="_blank" class="xanhworld_chat_zalo" rel="noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
        ...
        <!-- Gọi điện -->
        <a href="tel:{{ $settings->contact_phone ?? '' }}" class="xanhworld_chat_phone" aria-label="Phone" alt="Phone">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
        ...
        <!-- Trợ lý AI -->
        <a href="#" class="xanhworld_chat_facebook" data-ai-chat-trigger aria-label="Trợ lý AI dành riêng cho {{ $settings->site_name }}" alt="Trợ lý AI dành riêng cho {{ $settings->site_name }}">
