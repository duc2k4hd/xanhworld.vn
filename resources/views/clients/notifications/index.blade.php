...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (deleteReadBtn) {
        deleteReadBtn.addEventListener('click', function() {
            ...
            fetch('{{ route("client.notifications.delete-read") }}', {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}',
                    'Content-Type': 'application/json',
    ...
    function markAsRead(notificationId) {
        fetch(`{{ route("client.notifications.read", ":id") }}`.replace(':id', notificationId), {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}',
                'Content-Type': 'application/json',
    ...
    function deleteNotification(notificationId) {
        fetch(`{{ route("client.notifications.destroy", ":id") }}`.replace(':id', notificationId), {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}',
                'Content-Type': 'application/json',
