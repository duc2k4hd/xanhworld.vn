                    ...
                    r.forEach((r, f) => {
                        u.add(
                            ...
                            (r) => {
                                (e(a) || a(p, r)) &&
                                    (function (e) {
                                        if (new Date().getTime() - l > 10)
                                            return;
                                        s.emit("slideFocusStart"),
                                            (t.scrollLeft = 0);
                                        const r = o.findIndex((n) =>
                                            n.includes(e)
                                        );
                                        n(r) &&
                                            (c.useDuration(0),
                ...
                return {
                    init: function (e, r) {
                        return (
                            (t = r.filter(
                                ({ options: t }) =>
                                    !1 !== n.optionsAtMedia(t).active
                            )),
                            t.forEach((t) => t.init(e, n)),
                            r.reduce(
                                (n, t) => Object.assign(n, { [t.name]: t }),
                                {}
                            )
                        );
                    },
